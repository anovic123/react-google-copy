...
export const Footer: FC<FooterProps> = ({}) => {
  return (
    <footer className="bg-[#f2f2f2]">
      <div className="py-[.9375rem] md:px-[1.875rem] text-[.9375rem] border-b border-[#dadce0]">
        <span className="text=[#70767a] text-[.9375rem]">Украина</span>
      </div>

      <div className="flex flex-wrap justify-between md:px-[1.875rem] py-[.9375rem] gap-[.9375rem]">
