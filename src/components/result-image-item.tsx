...
export const ResultImageItem: FC<ResultImageItemProps> = ({ link, title, displayLink, image }) => {
  ...
  return (
    ...
    >
      <div className="rounded-xl overflow-hidden h-[6.25rem] md:h-[7.5rem] lg:h-[8.75rem] hover:shadow-c">
