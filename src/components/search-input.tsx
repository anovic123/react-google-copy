...
export const SearchInput: FC<SearchInputProps> = ({}) => {
  ...
  return (
    <div className="flex items-center min-h-[2.75rem] relative px-2 md:px-2 bg-white border border-solid border-gray-300 rounded-3xl w-full max-w-lg hover:shadow-blue-500/50">
